...
Since the generated functions are simple typescript functions, you can use them anywhere in your existing typescript projects. A UI is automatically generated that allows you to test this function
![image](/images/g-s-01.png)

## Motivation

There are a lot of other libraries out there that help developers write LLM chains.
However, a lot of them are in Python and require a lot of boilerplate code to get started or they are not fully typesafe.
...
The UI is automatically generated so all you have to worry about is writing your function. Think storybook for LLM's.
