...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={classnames(
      'text-white border-b border-neutral-800 transition-colors hover:bg-blue-900/10 data-[state=selected]:bg-blue-700/20',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={classnames('mt-4 text-sm text-neutral-500', className)}
    {...props}
  />
));
